...
// Sales, Marketing, and Listings arrive in later phases; their nav items
// exist now so the shell is complete, and route to a placeholder.
const PAGES = [
  { key: "overview", label: "Overview", phase: null },
  { key: "sales", label: "Sales", phase: 2 },
